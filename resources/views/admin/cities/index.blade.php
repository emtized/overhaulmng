...
<nav aria-label="breadcrumb">
    <ol class="lh-1-85 breadcrumb breadcrumb-style1">
        ...
        <li class="breadcrumb-item">
            <a href="javascript:void(0);">لیست شهر / شهرستان</a>
        </li>
        ...
        $(function () {
            ...
            if (dt_basic_table.length) {
                dt_basic = dt_basic_table.DataTable({
                    ...
                    buttons: [
                        {
                            text: '<i class="bx bx-plus me-sm-1"></i> <span class="d-none d-sm-inline-block">افزودن شهر جدید</span>',
                            className: 'create-new btn btn-primary ms-2'
                        }
                    ],
                });
                $('div.head-label').html('<h5 class="card-title mb-0">لیست شهر/شهرستان سیستم</h5>');
            }
